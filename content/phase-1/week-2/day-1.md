...
A feature in software product development is a distinct, user-facing capability or functionality that adds value to the product. It addresses specific needs, solves problems, or enhances the user experience. Features are described by what they do and why they matter, not by the details of how they are implemented.
...
Product owners typically prioritize features by analyzing user needs, business goals, and the potential impact on the overall product. They assess feedback, market trends, and technical feasibility to identify which features will deliver the most value in the shortest time. The next feature is chosen based on its alignment with the product vision and its ability to solve pressing problems or unlock new opportunities for users and the business.
...
<% checklist
Brainstormed several candidate Canvas features
Selected one medium-sized feature to pursue
Created agents/tasks/feature-1/feature-1.md for documenting the feature
Defined the feature's purpose and the problem it addresses, without specifying implementation details
Considered impact and feasibility of the feature
Prepared rationale for feature selection to discuss or pitch in class
Reviewed feature, scope, and product planning definitions above
Completed the feature quiz
Read Lab 3 instructions and minimum requirements
%>